...
//   }
// };
exports.getCouponTerms = async (req, res) => {
  try {
    // Find the coupon by its ID, projecting only the termsAndConditions field
    const coupon = await CouponMaster.findById(req.params._id, "termsAndConditions").exec();
